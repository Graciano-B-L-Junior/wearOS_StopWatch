...
import com.example.wearosstopwatch.presentation.viewModel.StopWatchViewModel
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val stopWatchText by viewModel.stopWatch.collectAsStateWithLifecycle()
            StopWatch(
                state = timerState,
                text = stopWatchText,
...
private fun StopWatch(
    ...
    Column(
        ...
        Row(
            ...
            Button(onClick = onReset, enabled = state != TimerState.RESET, colors =
